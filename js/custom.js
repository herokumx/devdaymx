...
jQuery(document).ready(function($){
	...
	var mainMenuHeight = $('.mainMenuWrapper').height();
	
	$('.mainMenuWrapper').css('margin-top', -mainMenuHeight);
	...
	$('.mainMenuButton').click(function(){
		...
		mainMenuHeight =  $('.mainMenuWrapper').height();
	...
	// adapt quick links function starts
	function adaptQuickLinks(){
		
		$('.quickLink').css('height', ($('.quickLinksWrapper').outerWidth() - 36)/2);
		$('.quickLinkIcon').css('height', $('.quickLink').height() - 36);
		
	};
	
	adaptQuickLinks();
	// adapt quick links function ends
